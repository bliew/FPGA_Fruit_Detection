...
//	hls::AXIM2Mat<1920,uint8_t,1080,1920,HLS_8UC1>(image_in,src);
	   hls::Mat<100,100,HLS_8UC1> src;
	   hls::Mat<100,100,HLS_8UC1> dst;
	   hls::AXIM2Mat<100,uint8_t,100,100,HLS_8UC1>(image_in,src);
	...
	hls::Mat2AXIM<100,uint8_t,100,100,HLS_8UC1>(dst,image_out);
